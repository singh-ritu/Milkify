...
export let itemsArray: Array<itemsType> = [
  {
    ...
    name: "Soy Milk",
    details:
      "Derived from soybeans, soy milk is a popular dairy alternative prized for its nutritional profile. It's naturally lactose-free, making it suitable for individuals with lactose intolerance. Soy milk is rich in protein, making it a great choice for those looking to boost their protein intake. ",
    price: 200,
  },
  {
    itemType: "vegan",
